...
COLOR_PAIRS = [('white', '16383998'), ('orange', '16351261'), ('magenta', '13061821'), ('light_blue', '3847130'),
               ('yellow', '16701501'), ('lime', '8439583'), ('pink', '15961002'), ('gray', '4673362'),
               ('cyan', '1481884'), ('purple', '8991416'), ('blue', '3949738'), ('brown', '8606770'),
               ('green', '6192150'), ('red', '11546150'), ('black', '1908001')]
BOOTS = {
    1: 'leather_boots',
    2: 'iron_boots',
    3: 'golden_boots'
...
ROAD_CHOICE = choice(ROAD_BLOCKS)
ROAD_SETS['default'] = ROAD_CHOICE[0]
ROAD_SETS['default_slabs'] = ROAD_CHOICE[1]
...
AGENT_ITEMS = {"REST": ["clock", "white_tulip", "white_wool", "white_bed"],
               ...
               "FAVORITE": ['apple', 'bread', 'melon_slice', 'golden_apple', 'book', 'diamond', 'emerald',
                            'nautilus_shell', 'cornflower', 'bamboo', 'torch', 'sunflower', 'zombie_head', 'ladder',
                            'poppy', 'warped_fungus'],
...
def correct_area(area):
    """
    Lexicographically order area bounds
    :param area:
    :return:
    """
...
def get_player_head_block_id(name, skull_set, rotation="1"):
    """
    Get Minecraft command for skull, the text when you run /data get block, from {SkullOwner onwards
    :param name:
    :param skull_set:
    :param rotation:
    :return:
...
def get_wood_type(block):
    """
	Return wood type (i.e. "jungle" from "minecraft:jungle_log"
	TODO Optimize
    :param block:
    :return:
    """
