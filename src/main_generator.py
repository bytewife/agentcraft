...
# print(sim.state.heightmaps[Heightmaps(1).name][5][7])

sim.state.update_heightmaps(5,7)
print(sim.state.update_node_type(5, 7))
# print(sim.state.determine_type(5, 7))
agent = Agent(sim.state, 0, 0, sim.state.walkable_heightmap, "JJ")
sim.add_agent(agent)
agent.get_nearest_trees(starting_search_radius=10, max_iterations=5)
